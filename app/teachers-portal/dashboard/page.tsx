...
import { LogOut, Users, Search, GraduationCap, ArrowLeft, Newspaper, FileText, Bell } from "lucide-react";
...
const TABS = ["Student Results", "College News", "Publications", "Notices"];
...
    fetch(`${API_URL}/api/student-portal-posts`)
      .then((res) => res.json())
      .then((json) => {
