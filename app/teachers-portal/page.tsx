...
import { Users, Mail, Lock, User, ArrowRight, Briefcase } from "lucide-react";
...
export default function TeacherPortalAuthPage() {

  const router = useRouter();

  const [mode, setMode] = useState<"login" | "signup">("login");

  const [form, setForm] = useState({ name: "", designation: "", email: "", password: "" });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/api/teacher-auth/${endpoint}`, {
      ...
      if (json.success) {
        ...
        localStorage.setItem("teacher_token", json.data.token);

        localStorage.setItem("teacher_name", json.data.name);
      ...
      <div className="w-full max-w-4xl bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="hidden md:flex flex-col justify-between bg-[#0f2418] text-white p-10">
          ...
          <div>
            ...
            <h2 className="text-2xl font-serif font-bold mb-3">Teacher Portal</h2>

            <p className="text-gray-300 text-sm leading-relaxed">

              Look up any student and view their published academic results — quickly and securely.
        ...
        <div className="p-8 md:p-10">
          ...
          <div className="flex mb-8 rounded-md overflow-hidden border border-gray-300">
            ...
            <button
              ...
              className={`flex-1 py-3 text-sm font-semibold transition-colors ${mode === "signup" ? "bg-[#0f2418] text-white" : "bg-white text-gray-700 hover:bg-gray-50"}`}
          ...
          <p className="text-sm text-gray-600 mb-6">
            ...
            {mode === "login" ? "Log in to search student results." : "Sign up with your official UAMC faculty email."}
              ...
              <>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Designation (optional, e.g. Assistant Professor)"
