...
export default function AlumniPage() {
  ...
  // Filter list based on search term & batch selection
  ...
  return (
    ...
    >
      ...
      <section className="bg-[#0f2418] text-white py-16 sm:py-20 px-4 sm:px-6 relative overflow-hidden">
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/15 text-emerald-300 text-xs font-semibold mb-4 backdrop-blur-xs">
          ...
          <p className="text-slate-300 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
            Celebrating the proud graduates of Uttara Adhunika Medical College making an impact worldwide.
          </p>
          ...
          <div className="mt-8">
            <Link
              href="/alumni-portal"
              className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-semibold px-5 py-2.5 rounded-xl transition-all shadow-md active:scale-[0.98]"
            >
            ...
            {filteredList.map((person) => {
              ...
              return (
                <div
                  ...
                  style={{ backgroundColor: "#ffffff" }}
                >
                  {/* Photo Container with Batch Badge */}
